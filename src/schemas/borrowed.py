...
class BorrowedSchema(BaseModel):
    ...
    user_id: int = Field(title="The ID of the user who is borrowing")
    ...
    return_date: Optional[datetime] = Field(title="Date on which book is returned by the user", default=None)
