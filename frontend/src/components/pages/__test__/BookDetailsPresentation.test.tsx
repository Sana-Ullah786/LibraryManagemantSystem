...
describe('Tests correct correct rendering of style and headings', () => {
    ...
    test('renders without error', () => {
        ...
        render(
            < StaticRouter >
                <BookDetailsPresentation book={book} author={author} language={language} genres={genres} />
            </StaticRouter>
        );
    ...
    /**
     * This test checks if the text of summary heading is correct
     */
    test('renders correct heading for summary', () => {
        ...
        expect(getByTestId("summaryHeading")).toHaveTextContent("Summary:");
...
describe("Tests correct data displayed for each heading", () => {
    ...
    test('renders correct author name', () => {
        ...
        expect(getByTestId("author")).toHaveTextContent(author.last_name + ", " + author.first_name);

    });

    /**
     * This test checks if summary has correct text
     */
    test('renders correct summary text', () => {
        ...
        expect(getByTestId("summary")).toHaveTextContent(book.summary);
    ...
    test('renders correct genres text', () => {
        ...
        expect(getByTestId("genres")).toHaveTextContent(Object.values(genres).map((genre) => genre.name).join(", "));
