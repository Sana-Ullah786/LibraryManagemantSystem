...
export class APIClient{
	...
	public GetBookDetails(id: string): Promise<BookSaved>{
		return new Promise((resolve,reject)=>{
			APIClient.axiosInstance.get("/books/" + id)
			.then(res => {
	...
	public CreateBook(book: Book): Promise<number>{
		return APIClient.axiosInstance.post('/books/', this.bookSerialize(book))
        .then(res =>{
	...
	public UpdateBook(book: Book, id: number): Promise<boolean>{
		return APIClient.axiosInstance.put("/books/"+String(id)+"/", this.bookSerialize(book))
		.then(res=>{
			return true;
		})
	}
	...
	public DeleteBook(id: string): Promise<boolean> {
		return APIClient.axiosInstance.delete('/books/' + id + "/")
		.then(res=>{
			return true;
		})
	}
	...
	public GetBookList(): Promise<BookSaved[]>{
		return new Promise((resolve,reject)=>{
			APIClient.axiosInstance.get("/books")
			.then(response => {
	...
	public GetGenreDetails(id: string): Promise<Genre> {
		return new Promise((resolve,reject)=>{
			 APIClient.axiosInstance.get(`genres/${id}`)
			.then(res => {
	...
	public GetAllGenres(): Promise<Genre[]> {
		return new Promise((resolve,reject)=>{
			APIClient.axiosInstance.get(`genres/`)
			.then(res => {
	...
	public GetAllLanguages(): Promise<Language[]>{
		return new Promise((resolve,reject)=>{
			APIClient.axiosInstance.get('languages/')
			.then(res => {
	...
	public GetLanguageDetails(id: string): Promise<Language> {
		return new Promise((resolve,reject)=>{
			APIClient.axiosInstance.get(`languages/${id}`)
			.then(res => {
	...
	public GetAuthorDetails(id: string): Promise<Author>{
		return new Promise((resolve,reject) => {
			APIClient.axiosInstance.get("/authors/"+id)
			.then(res=>{
	...
	public GetAllAuthors(): Promise<Author[]>{
		return new Promise((resolve,reject)=>{
			APIClient.axiosInstance.get("/authors/")
			.then(res=>{
	...
	public GetHomePageData():Promise<HomeData>{
		return new Promise((resolve,reject)=>{
			APIClient.axiosInstance.get("/home")
			.then(res=>{
